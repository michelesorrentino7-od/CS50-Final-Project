...
(function () {
    ...
    const IT = {
        ...
        'gr.mth.2.body':    'Traduciamo obblighi, rischi è lacune in un framework snello e verificabile. Risk register, control map, set di KRI, percorsi di escalation e template di reporting — costruiti negli strumenti già usati dal team.',
        'gr.mth.3.name':    'Integrazione',
        'gr.mth.3.body':    'Trasferiamo la ownership al team con documentazione, workshop e, dove opportuno, automazione dell\'evidenze tramite software esistente, pipeline di dati o revisione assistita dall\'IA.',
